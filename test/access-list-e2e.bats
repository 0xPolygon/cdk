...
add_to_access_list() {
    ...
    run kurtosis service exec $enclave $sequencer "acl add --datadir $data_dir --address $sender --type $acl_type --policy $policy"
}
...
set_acl_mode() {
    ...
    run kurtosis service exec $enclave $sequencer "acl mode --datadir $data_dir --mode $mode"
}
