...
func (_m *L2BridgeSyncerMock) EXPECT() *L2BridgeSyncerMock_Expecter {
	return &L2BridgeSyncerMock_Expecter{mock: &_m.Mock}
}
...
func (_e *L2BridgeSyncerMock_Expecter) BlockFinality() *L2BridgeSyncerMock_BlockFinality_Call {
	return &L2BridgeSyncerMock_BlockFinality_Call{Call: _e.mock.On("BlockFinality")}
}
...
func (_e *L2BridgeSyncerMock_Expecter) GetBlockByLER(ctx interface{}, ler interface{}) *L2BridgeSyncerMock_GetBlockByLER_Call {
	return &L2BridgeSyncerMock_GetBlockByLER_Call{Call: _e.mock.On("GetBlockByLER", ctx, ler)}
}
...
// L2BridgeSyncerMock_GetBridges_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetBridges'
type L2BridgeSyncerMock_GetBridges_Call struct {
	*mock.Call
}
...
//   - fromBlock uint64
//   - toBlock uint64
func (_e *L2BridgeSyncerMock_Expecter) GetBridges(ctx interface{}, fromBlock interface{}, toBlock interface{}) *L2BridgeSyncerMock_GetBridges_Call {
	return &L2BridgeSyncerMock_GetBridges_Call{Call: _e.mock.On("GetBridges", ctx, fromBlock, toBlock)}
}

func (_c *L2BridgeSyncerMock_GetBridges_Call) Run(run func(ctx context.Context, fromBlock uint64, toBlock uint64)) *L2BridgeSyncerMock_GetBridges_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *L2BridgeSyncerMock_GetBridges_Call) Return(_a0 []bridgesync.Bridge, _a1 error) *L2BridgeSyncerMock_GetBridges_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *L2BridgeSyncerMock_GetBridges_Call) RunAndReturn(run func(context.Context, uint64, uint64) ([]bridgesync.Bridge, error)) *L2BridgeSyncerMock_GetBridges_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *L2BridgeSyncerMock_Expecter) GetClaims(ctx interface{}, fromBlock interface{}, toBlock interface{}) *L2BridgeSyncerMock_GetClaims_Call {
	return &L2BridgeSyncerMock_GetClaims_Call{Call: _e.mock.On("GetClaims", ctx, fromBlock, toBlock)}
}
...
func (_e *L2BridgeSyncerMock_Expecter) GetExitRootByIndex(ctx interface{}, index interface{}) *L2BridgeSyncerMock_GetExitRootByIndex_Call {
	return &L2BridgeSyncerMock_GetExitRootByIndex_Call{Call: _e.mock.On("GetExitRootByIndex", ctx, index)}
}
...
func (_e *L2BridgeSyncerMock_Expecter) GetLastProcessedBlock(ctx interface{}) *L2BridgeSyncerMock_GetLastProcessedBlock_Call {
	return &L2BridgeSyncerMock_GetLastProcessedBlock_Call{Call: _e.mock.On("GetLastProcessedBlock", ctx)}
}
...
func (_e *L2BridgeSyncerMock_Expecter) OriginNetwork() *L2BridgeSyncerMock_OriginNetwork_Call {
	return &L2BridgeSyncerMock_OriginNetwork_Call{Call: _e.mock.On("OriginNetwork")}
}
