...
// DownloaderMock is an autogenerated mock type for the downloaderFull type
...
func (_m *DownloaderMock) download(ctx context.Context, fromBlock uint64, downloadedCh chan block) {
