...
type mockConstructorTestingTNewGlobalExitRootBananaContractor interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewGlobalExitRootBananaContractor(t mockConstructorTestingTNewGlobalExitRootBananaContractor) *GlobalExitRootBananaContractor {
